...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        ObjectAnimator animatorScaleX = ObjectAnimator.ofFloat(findViewById(R.id.target),"scaleX", (float) 0.5,(float)1.5);
        ...
        ObjectAnimator animatorScaleY = ObjectAnimator.ofFloat(findViewById(R.id.target),"scaleY", (float) 0.5,(float)1.5);
        ...
        ObjectAnimator animatorAlpha = ObjectAnimator.ofFloat(findViewById(R.id.target),"alpha", 1.0f,0.2f);
