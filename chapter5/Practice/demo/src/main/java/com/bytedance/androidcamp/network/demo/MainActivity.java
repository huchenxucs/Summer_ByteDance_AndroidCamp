...
public class MainActivity extends AppCompatActivity {
    ...
    public void testJSONObject(View view)  {
        ...
        try {
            ...
            Toast.makeText(MainActivity.this, "TODO1 error: " +
    ...
    public void testHttpURLConnectionSync(View view) {
        ...
        Thread thread = new Thread(new Runnable() {
            @Override
            public void run() {
                final String s = NetworkUtils.
                        getResponseWithHttpURLConnection(ICatService.HOST + ICatService.PATH);
                try {
                 ...
                 e.printStackTrace();
                 Toast.makeText(MainActivity.this, "TODO4 error: " +
                            e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void testRetrofitSync(View view) throws Exception {
        ...
        mAsyncTask = new AsyncTask<Object, Integer, String>(){
            @Override
        ...
        new Thread() {
            @Override public void run() {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(MainActivity.this, "TODO6 error: " +
                            e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        }.start();
        ...
        new Thread() {
            @Override public void run() {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(MainActivity.this, "retrofit: " +
                            e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        }.start();
