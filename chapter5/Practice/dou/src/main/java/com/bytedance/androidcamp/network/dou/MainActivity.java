...
public class MainActivity extends AppCompatActivity {
    ...
    private void postVideo() {
        ...
        Call<PostVideoResponse> call = miniDouyinService.postVideo("3170104243","huchenxu", coverImagePart, videoPart);
        call.enqueue(new Callback<PostVideoResponse>() {
            @Override
            public void onResponse(Call<PostVideoResponse> call, Response<PostVideoResponse> response) {
                if (response.isSuccessful() && response.body() != null) {
                    PostVideoResponse postRes = response.body();
                    if (postRes.getSuccess()) {
            ...
            public void onFailure(Call<PostVideoResponse> call, Throwable throwable) {
                Toast.makeText(MainActivity.this, "upload failed! "+throwable.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void fetchFeed(View view) {
        ...
        call.enqueue(new Callback<GetVideosResponse>() {
            ...
            public void onResponse(Call<GetVideosResponse> call, Response<GetVideosResponse> response) {
                if (response.isSuccessful() && response.body() != null) {
                    GetVideosResponse getRes = response.body();
                    if (getRes.getSuccess()) {
                        Toast.makeText(MainActivity.this , "get successfully!", Toast.LENGTH_SHORT).show();
                        mVideos = getRes.getFeeds();
            ...
            public void onFailure(Call<GetVideosResponse> call, Throwable throwable) {
                Toast.makeText(MainActivity.this, "get failed! "+throwable.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
