...
public class IJKPlayerActivity extends Activity implements View.OnClickListener {
    ...
    private  void init_video_seekbar(){
        mVolumeSeekBar.setProgress(50);
        ijkPlayer.mMediaPlayer.setVolume(mVolumeSeekBar.getProgress()/100f,mVolumeSeekBar.getProgress()/100f);
    }
    private void init() {
        ...
        mVolumeSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ijkPlayer.mMediaPlayer.setVolume(seekBar.getProgress()/100f,seekBar.getProgress()/100f);
            }
